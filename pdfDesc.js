...
// גרסת מנוע החילוץ — שינוי מכריח חילוץ מחדש של מסמכים שנשמרו בגרסה ישנה.
export const EXTRACT_VERSION = 2;

// שורות "רעש" שאינן תיאור המסמך — שם עוסק, כותרות, סכומים, פרטי קשר, וכן ה-boilerplate של פייפרלס.
const NOISE = [
  ...
  // boilerplate של פייפרלס בתחתית המסמך (מגיע מעורבל) — לא להציג
  /פייפרלס|paperless/i, /הופק/, /נייר/, /הנהלת\s*חשבונות/, /דיגיטלית/, /נחתם/, /חשבונותהנהלת/,
];
