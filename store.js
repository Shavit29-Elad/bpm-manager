...
const EMPTY = {
  ...
  requests: [],    // בקשות פיתוח שנוצרות מסיכום שיחות עם הצוות (איריס): { id, memberName, title, summary, details, priority, status, createdAt }
  ...
  artistClientMap: [ // מיפוי זמר → לקוח ברירת-מחדל (מולא אוטומטית בקליטת אירוע)
    ...
    { artist: 'אגם בוחבוט', clientName: 'גאגא בוקינג בע״מ' },
    { artist: 'שרית חדד', clientName: 'כספית ייצוג והפקת אומנים ואירועים בעמ - שרית' },
    { artist: 'היוצרים', clientName: 'סיטי הפקות (ת.ס) בע' },
    { artist: 'קובי פרץ', clientName: 'ליאל הפקות בע״מ' },
    { artist: 'אושר כהן', clientName: 'א.מ הפקות מוסיקה בע״מ - אושר' },
    { artist: 'עדן בן זקן', clientName: 'שרית הפקות בע״מ' },
  ],
};
